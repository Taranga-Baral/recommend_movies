...
<body>
    ...
    <h4>Here you can recommend Other Your Taste for Movies.</h4>
    <ul class="cards">
        @foreach ($movies as $movie)
        <li>
            <form action="{{ route('recommend-other.store') }}" method="post">
                @csrf
                ...
                <input type="hidden" name="type" value="recommended_movies">
                ...
                <a class="card">
                  ...
                  <button type="submit">This Movie is Worth Watching - View it</button>
            </form>
      ...
      {{-- Form  --}}
      <form action="{{ route('recommend-other.index') }}" method="GET" class="form-container">
